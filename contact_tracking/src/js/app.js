(function () {
    ...
    var sliders = {
        ...
        radar: [
            document.getElementById('radar-slider'),
            document.getElementById('radar-percent')
        ]
    };
    var stats = {
        ...
        radar: document.getElementById('radar-number')
    };
    ...
    btns.start.addEventListener('click', function(){
        ...
        Simulation.init(simulation, chart, simulationStats, simulationEnd, {
            ...
            radarPopulation: parseInt(slidersValues.population * slidersValues.radar / 100),
